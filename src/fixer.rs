...
pub fn apply_fixes(
    ...
    for diag in diagnostics {
        ...
        edits.push(SourceEdit::new(start_byte, end_byte, &suggestion.replacement));
    }
...
pub fn format_diff_with_context(original: &str, fixed: &str, path: &Path, context: usize) -> String {
    use std::fmt::Write;
